...
export const contractAbi = {
  vite_0000000000000000000000000000000000000004d28108e76b: [
    {
      ...
      inputs: [
        ...
        { name: 'perCount', type: 'int64' },
        { name: 'randCount', type: 'uint8' },
        { name: 'randRank', type: 'uint8' },
        { name: 'repeat', type: 'uint16' },
        { name: 'checkLevel', type: 'uint8' },
        { name: 'countingTokenId', type: 'tokenId' },
        { name: 'registerConditionId', type: 'uint8' },
        { name: 'registerConditionParam', type: 'bytes' },
        { name: 'voteConditionId', type: 'uint8' },
        { name: 'voteConditionParam', type: 'bytes' },
...

    {
      ...
      inputs: [
        ...
        { name: 'expirationHeight', type: 'uint64' },
        { name: 'rewardTime', type: 'int64' },
        { name: 'revokeTime', type: 'int64' },
        { name: 'hisAddrList', type: 'address[]' }
      ]
    },
    {
      type: 'variable',
  ...
  vite_000000000000000000000000000000000000000595292d996d: [
...

    {
      ...
      inputs: [{ name: 'tokenId', type: 'tokenId' }]
    },
    {
      type: 'function',
      name: 'DisableReIssue',
  ...
  vite_00000000000000000000000000000000000000079710f19dc7: [
    ...
    },
    {
      ...
      inputs: [{ name: 'orderId', type: 'bytes' }]
    },
    {
      type: 'function',
    ...
    },
    {
      ...
      inputs: [{ name: 'sendHash', type: 'bytes32' }]
    },
  ...
  vite_0000000000000000000000000000000000000006e82b8ba657: [
    ...
    },
    {
      type: 'function',
      name: 'NotifyTime',
      inputs: [{ name: 'timestamp', type: 'int64' }]
    },
